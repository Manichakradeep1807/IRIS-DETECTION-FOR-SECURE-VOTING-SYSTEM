...
class VideoMusicCombiner:
    ...
    def create_enhanced_background_music(self):
        ...
        try:
            ...
            print("✅ Enhanced background music created: {}".format(audio_file))
            return audio_file
            
        except Exception as e:
            print("❌ Error creating enhanced music: {}".format(e))
            return None
    ...
    def combine_with_ffmpeg(self):
        ...
        try:
            ...
            print("📹 Video: {}".format(self.video_file))
            print("🎵 Audio: {}".format(self.audio_file))
            print("📁 Output: {}".format(self.output_file))
            ...
            if result.returncode == 0:
                if os.path.exists(self.output_file):
                    ...
                    print("✅ Success! Video with music created: {}".format(self.output_file))
                ...
                print("❌ FFmpeg error: {}".format(result.stderr))
                return False
                
        except Exception as e:
            print("❌ Error combining video and audio: {}".format(e))
            return False
    ...
    def create_video_with_embedded_audio(self):
        ...
        try:
            ...
            if not cap.isOpened():
                print("❌ Cannot open video: {}".format(self.video_file))
                return False
            ...
            print("📊 Video properties: {}x{height} @ {fps}fps, {total_frames} frames".format(width))
            ...
            while True:
                ...
                if frame_count % (fps * 5) == 0:  # Every 5 seconds
                    ...
                    print("⏳ Processing: {}%".format(progress:.1f))
            ...
            if self.check_ffmpeg():
                ...
                if result.returncode == 0:
                    ...
                    print("✅ Video with music created: {}".format(self.output_file))
                    return True
                else:
                    # Rename temp video as fallback
                    os.rename(temp_video, self.output_file)
                    print("⚠️ Audio combination failed, but video saved: {}".format(self.output_file))
                    print("🎵 Play {} separately for background music".format(audio_file))
                    return True
            else:
                # Rename temp video as fallback
                os.rename(temp_video, self.output_file)
                print("⚠️ FFmpeg not available, but video saved: {}".format(self.output_file))
                print("🎵 Play {} separately for background music".format(audio_file))
                return True
                
        except Exception as e:
            print("❌ Error in alternative method: {}".format(e))
            return False
    ...
    def add_background_music(self):
        ...
        print("📹 Input video: {} ({video_size:.1f} MB)".format(self.video_file))
        ...
        if success:
            ...
            print("📁 Output: {}".format(self.output_file))
            print("\n🎬 How to play:")
            print("   Double-click: {}".format(self.output_file))
