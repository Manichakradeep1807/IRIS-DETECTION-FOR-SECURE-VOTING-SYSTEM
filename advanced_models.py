...
def create_ensemble_model(models, input_shape=(64, 64, 3), num_classes=108):
    ...
    for i, model in enumerate(models):
        ...
        for layer in model.layers:
            ...
            layer._name = "{}_{i}".format(layer.name)
...
if __name__ == "__main__":
    ...
    print("Advanced model parameters: {:,}".format(advanced_model.count_params()))
    print("Efficient model parameters: {:,}".format(efficient_model.count_params()))
