...
class SettingsWindow:
    ...
    def _create_widgets(self):
        ...
        title_label = tk.Label(main_frame,
                              text="⚙️ {}".format(get_text('settings_title', 'System Settings')),
    ...
    def _create_theme_section(self, parent, colors):
        ...
        theme_frame = tk.LabelFrame(parent,
                                   text="🎨 {}".format(get_text('settings_theme', 'Theme Selection')),
    ...
    def _create_language_section(self, parent, colors):
        ...
        language_frame = tk.LabelFrame(parent,
                                      text="🌐 {}".format(get_text('settings_language', 'Language Selection')),
                                      font=('Segoe UI', 12, 'bold'),
                                      fg=colors['text_primary'],
                                      bg=colors['secondary'],
                                      relief='raised',
    ...
    def _create_buttons_section(self, parent, colors):
        ...
        apply_btn = tk.Button(button_frame,
                             text="✅ {}".format(get_text('settings_apply', 'Apply Changes')),
        ...
        reset_btn = tk.Button(button_frame,
                             text="🔄 {}".format(get_text('settings_reset', 'Reset to Default')),
                             font=('Segoe UI', 11, 'bold'),
                             fg='white',
                             bg=colors['warning'],
                             relief='flat',
        ...
        cancel_btn = tk.Button(button_frame,
                              text="❌ {}".format(get_text('settings_cancel', 'Cancel')),
                              font=('Segoe UI', 11, 'bold'),
                              fg='white',
                              bg=colors['danger'],
                              relief='flat',
        ...
        try:
            ...
            if theme_changed or language_changed:
                messagebox.showinfo(
                    ...
                    "{} ".format(get_text('settings_apply', 'Settings applied successfully!')) +
            ...
            messagebox.showerror(
                get_text('error', 'Error'),
                "Error applying settings: {}".format(str(e))
            )
